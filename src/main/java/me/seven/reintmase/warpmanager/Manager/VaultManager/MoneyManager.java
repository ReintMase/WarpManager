...
public class MoneyManager {
    ...
    public void payMoneyCreator(String playerName, int moneyForGive) {
        OfflinePlayer depPlayer = Bukkit.getOfflinePlayer(playerName);

        if (depPlayer.hasPlayedBefore() || depPlayer.isOnline()) {
            economy.depositPlayer(depPlayer, moneyForGive);
        }
    }
